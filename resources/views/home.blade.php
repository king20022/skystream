                ...
                <div class="item bg-parallax item-2">
                    <div class="slider-content">
                        <div class="col-md-12">
                            <div class="container">
                                <div class="slider-text text-center">
                                    <h3 class="slide-title"><span>Crypto</span> Investment <br />You can
                                        <span>Trust</span>
                                    </h3>
                                    <p>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="title-head-subtitle">
                        <p>SuperTrix Fx is an Online Digital trading platform, where companies, individuals and firms
                            are
                            given the opportunity to earn from Crypto trading & forex Exchange, by investing their
                            capital
                ...
                <div class="row about-content">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-6 text-center">
                        <img id="about-us" class="img-responsive img-about-us" src="images/about-us.png"
                            alt="about us">
                    </div>
                    <!-- Image Ends -->
                    <!-- Content Starts -->
                    <div class="col-sm-12 col-md-7 col-lg-6">
                        ...
                        <p class="about-text">A special trading system developed by our specialists significantly
                            reduces
                            financial risks, while increasing the efficiency of trading sessions at the same time.
                            Verityinvest has its own business model, which allows investors to receive high interest
                            rates
                        ...
                        <div class="tab-content">
                            <div id="menu1" class="tab-pane fade in active">
                                <p>The platform created by us provides our investors with the most comfortable
                                    conditions,
                                    in order to help them engage in the investment process. Our professional traders,
                                    guided
                                    by their own unique trading strategy, will allow our clients to receive such
                                    revenue,
                                    which even an experienced investor will envy. The whole investment process takes
                                    place
                            ...
                            <div id="menu2" class="tab-pane fade">
                                <p>Adhering to highest compliance standards <br>
                                    ...
                                    As an international regulated financial intermediary subject to the rules set out by
                                    the
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 ts-padding img-block-left">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="title-head-subtitle">
                                <p>We are a worldwide investment company committed to the principle of revenue
                                    maximization
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    ...
                                    <p>Promote the company and earn unlimited referral commission from each referral.
                                    </p>
                                </div>
                            </div>
                            <!-- Feature Ends -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    ...
                                    <p>Get mining with a big profit, and Miner is calculated with the blockchain
                                        ecosystem.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    ...
                                    <p>Our investment plans are tailored to the level of your investment opportunities.
                                    </p>
                                </div>
                            </div>
                            <!-- Feature Ends -->
                        ...
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapse1" class="panel-collapse collapse in">
                                    <div class="panel-body">Create your own account to get started. It takes a few
                                        minutes
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapse3" class="panel-collapse collapse">
                                    <div class="panel-body">Sky stream exchange does not take any commissions on your
                                        transactions. But such commissions can be taken by the payment systems or
                                        payment
                                        aggregator.</div>
                                </div>
                                <!-- Panel Content Starts -->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapse4" class="panel-collapse collapse">
                                    <div class="panel-body">In case you wish to stop using your account, please contact
                                        our
