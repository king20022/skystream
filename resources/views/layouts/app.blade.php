        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="admin-action-info"> <span>Welcome</span>
                    ...
                    <ul>
                        <li><a data-placement="bottom" title="Go to Inbox" href="mail-inbox.html"><i
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="events.html"><i class="zmdi zmdi-calendar-check"></i><span>Event Management</span>
                        </a></li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-account"></i><span>Professors</span> </a>
                        <ul class="ml-menu">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-book"></i><span>Library</span> </a>
                        <ul class="ml-menu">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Extra
                                Pages</span> </a>
                        <ul class="ml-menu">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-blogger"></i><span>Blogger</span> </a>
                        <ul class="ml-menu">
                    ...
                    <li><a href="javascript:void(0);"><i
                                class="zmdi zmdi-chart-donut col-red"></i><span>Important</span></a></li>
                    <li><a href="javascript:void(0);"><i
                                class="zmdi zmdi-chart-donut col-amber"></i><span>Warning</span></a></li>
                    <li><a href="javascript:void(0);"><i
                                class="zmdi zmdi-chart-donut col-blue"></i><span>Information</span></a></li>
                </ul>
            </div>
            <!-- #Menu -->
        </aside>
                ...
                <div role="tabpanel" class="tab-pane" id="chat">
                    <div class="demo-settings">
                        ...
                        <ul>
                            <li class="online">
                                <div class="media">
                                    <a role="button" tabindex="0"> <img class="media-object "
                                            src="asset/images/xs/avatar1.jpg" alt=""> </a>
                            ...
                            <li class="online">
                                <div class="media"> <a role="button" tabindex="0"> <img class="media-object "
                                            src="asset/images/xs/avatar2.jpg" alt=""> </a>
                                    <div class="media-body">
                            ...
                            <li class="online">
                                <div class="media"> <a role="button" tabindex="0"> <img class="media-object "
                                            src="asset/images/xs/avatar3.jpg" alt=""> </a>
                                    <div class="media-body">
                        ...
                        <ul>
                            <li class="offline">
                                <div class="media"> <a role="button" tabindex="0"> <img class="media-object "
                                            src="asset/images/xs/avatar4.jpg" alt=""> </a>
                                    <div class="media-body">
                            ...
                            <li class="offline">
                                <div class="media"> <a class="pull-left " role="button" tabindex="0"> <img
                                            class="media-object " src="asset/images/xs/avatar2.jpg" alt="">
                                    </a>
                                    <div class="media-body">
                                        <span class="name">Joel King</span> <span
                                            class="badge badge-outline status"></span>
