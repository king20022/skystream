                            ...
                            <div class="body">
                                <div class="member-card verified">
                                    <div class="m-t-20">
                                        ...
                                        <p class="text-pink mb-0">Investment Type</p>
                                        <p class="text-muted"> <b>{{ $investment->investmentType }} </b><span></p>
                                        <p class="text-pink mb-0">Minimum</p>
                                        <p class="text-muted"> <b>{{ $investment->minimum }} </b></p>

                                    </div>
                                    <p class="text-pink mb-0">Maximum</p>
                                    <p class="text-muted"> <b>{{ $investment->maximum }} </b></p>
                                    <p class="text-pink mb-0">Pip</p>
                                    <p class="text-muted"> <b>{{ $investment->pip }} </b></p>
