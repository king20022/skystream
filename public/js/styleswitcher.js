...
jQuery(document).ready(function() {
	...
	var orange = true;
		...
		$('#orange-css').on('click', function () {
			...
			if (logouser.length) {
				document.getElementById('logo-user').src='images/styleswitcher/logos/logo-dark.html';
			}
		...
		$('#green-css').on('click', function () {
			...
			var logouser = $('#logo-user');
			if (logouser.length) {
				document.getElementById('logo-user').src='images/styleswitcher/logos/green-dark.html';
			}
			var aboutimg = $('#about-us');
			if (aboutimg.length) {
				document.getElementById('about-us').src='images/styleswitcher/about-us-green.html';
